...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    id: "u-fac-005",
    facultyId: "fac-005",
    name: "รศ.ดร.ศศิธร ชูศรี",
    email: "lead@mfu.ac.th",
    role: "committee",
    committeeId: "cmt-curriculum",
    hint: "Committee Lead · edits, sends back, forwards",
  },
  {
    personaId: "committee-counselor",
    id: "u-fac-001",
    facultyId: "fac-001",
    name: "อ.ดร.นิเวศน์ กุลวงค์",
    email: "counselor@mfu.ac.th",
    role: "committee",
    committeeId: "cmt-curriculum",
