...
export const kpis: Kpi[] = [
  { id: "kpi-grad-rate", name: "Graduation Rate", category: "student_success", weight: 35, calculationMethod: "Formula: Graduation Rate", calculationType: "custom_formula", currentValue: 88.4, unit: "%", thresholds: { green: 85, amber: 75 }, formulaId: "formula-grad-rate", committeeIds: allCommitteeIds },
  { id: "kpi-licensure", name: "Licensure Pass Rate", category: "student_success", weight: 35, calculationMethod: "Formula: Licensure Pass Rate", calculationType: "custom_formula", currentValue: 91.2, unit: "%", thresholds: { green: 90, amber: 80 }, formulaId: "formula-licensure", committeeIds: allCommitteeIds },
  { id: "kpi-employment", name: "Post-Grad Employment", category: "student_success", weight: 30, calculationMethod: "Formula: Post-Grad Employment Rate", calculationType: "custom_formula", currentValue: 84.7, unit: "%", thresholds: { green: 85, amber: 70 }, formulaId: "formula-employment", committeeIds: allCommitteeIds },
  { id: "kpi-research-index", name: "Research Productivity Index", category: "research_output", weight: 50, calculationMethod: "Formula: Research Productivity Index", calculationType: "custom_formula", currentValue: 72.0, unit: "score", thresholds: { green: 70, amber: 50 }, formulaId: "formula-research-index", committeeIds: allCommitteeIds },
  { id: "kpi-pub-output", name: "Publications per FTE", category: "research_output", weight: 50, calculationMethod: "Sum publications / FTE faculty", calculationType: "weighted_sum", currentValue: 2.3, unit: "ratio", thresholds: { green: 2, amber: 1 }, committeeIds: allCommitteeIds },
  { id: "kpi-faculty-quals", name: "Faculty Qualification Index", category: "faculty_excellence", weight: 60, calculationMethod: "% faculty with terminal degree", calculationType: "weighted_sum", currentValue: 78.0, unit: "%", thresholds: { green: 80, amber: 65 }, committeeIds: allCommitteeIds },
  { id: "kpi-student-ratio", name: "Student-Faculty Ratio", category: "operational_efficiency", weight: 40, calculationMethod: "Enrolled students / FTE faculty", calculationType: "weighted_sum", currentValue: 14.2, unit: "ratio", thresholds: { green: 15, amber: 20 }, committeeIds: allCommitteeIds },
  { id: "kpi-cost-per-student", name: "Cost per Student", category: "financial_health", weight: 50, calculationMethod: "Operating cost / enrolled students (THB k)", calculationType: "weighted_sum", currentValue: 92, unit: "THB k", thresholds: { green: 100, amber: 130 }, committeeIds: allCommitteeIds },
];
